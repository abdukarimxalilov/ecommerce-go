...
func (app *Application) AddToCart() gin.HandlerFunc{
	return func (c *gin.Context) {
		// this checks whether productqueryID is empty
		...
		// checks for userqueryID is whether blank or not
...
func (app *Application) RemoveItem() gin.HandlerFunc{
	...
	return func (c *gin.Context) {
		...
		err = database.RemoveCartFrom(ctx, app.prodCollection, app.userCollection, productID, userQueryID)
		if err != nil{
			c.IndentedJSON(http.StatusInternalServerError, err)
			return
		}
